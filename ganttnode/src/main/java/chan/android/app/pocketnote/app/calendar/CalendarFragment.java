...
public class CalendarFragment extends SherlockFragment implements View.OnTouchListener, NoteAdapterNotifier {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView textView = (TextView) root.findViewById(R.id.calendar_$_textview_month);
...
//                    final int day = item.getDay();
//                    openNoteActivityByDate(day, month, year);
                }
            }
        });
    }
    ...
    by keitsi
     */
    private void openNoteActivityByDate(int day, int month, int year) {

//        Intent intent = new Intent(getSherlockActivity(), SettingItemAdapter.class);
...
//        startActivity(intent);
        ...
        ft.replace(R.id.content, NotesFragment.newInstance(), NotesFragment.TAG);
        ft.commit();
